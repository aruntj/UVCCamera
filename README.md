...
Modified Setup and run guide
=========
1. Install Android studio
2. Install Andoid SDK (I've used 27 - Oreo 8.1 - need this for android support tools 27.1.1 compatibility):
    1. Tools > SDK Manager > SDK Platform -- choose Oreo 8.1
    2. Install NDK Tools > SDK Manager > SDK Tools -- choose LLDB and NDK
    3. Click apply and wait for download and sync to complete.
4. Clone project - https://github.com/aruntj/UVCCamera.git    
5. Switch to theia branch
6. Build libuvccamera by going to the libuvccamera directory and running gradle build.
7. Make project.
8. Select sub project from run menu click run. 
    1. Do not use adb for now choose android emulator.
    2. Install the virtual machine for the phone of your choice when prompted.
    3. Update the haxm for mac when prompted.
    4. Wait for install and the app should show up on the screen.
